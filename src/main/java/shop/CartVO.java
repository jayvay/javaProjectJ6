...
public class CartVO {
	...
	private int totAlbumCnt;	//같은 앨범을 장바구니에 담으면 개수만 +1
	...
	public int getTotAlbumCnt() {
		return totAlbumCnt;
	}

	public void setTotAlbumCnt(int totAlbumCnt) {
		this.totAlbumCnt = totAlbumCnt;
	}
	...
	public String toString() {
		return "CartVO [idx=" + idx + ", mid=" + mid + ", albumIdx=" + albumIdx + ", albumCnt=" + albumCnt + ", salePrice="
				...
				+ ", stock=" + stock + ", saleCnt=" + saleCnt + ", photo=" + photo + ", totAlbumCnt=" + totAlbumCnt + "]";
	}
